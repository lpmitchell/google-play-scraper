...
[![GoDoc](https://godoc.org/github.com/lpmitchell/google-play-scraper/pkg?status.svg)](https://godoc.org/github.com/lpmitchell/google-play-scraper/pkg)
[![Go Report Card](https://goreportcard.com/badge/github.com/lpmitchell/google-play-scraper)](https://goreportcard.com/report/github.com/lpmitchell/google-play-scraper)
[![Coverage Status](https://coveralls.io/repos/github/lpmitchell/google-play-scraper/badge.svg?branch=master)](https://coveralls.io/github/lpmitchell/google-play-scraper?branch=master)
...
```shell
go get -u github.com/lpmitchell/google-play-scraper/...
```
...
import (
    ...
    "github.com/lpmitchell/google-play-scraper/pkg/app"
)
...
import (
    ...
    "github.com/lpmitchell/google-play-scraper/pkg/search"
)
...
import (
    ...
    "github.com/lpmitchell/google-play-scraper/pkg/category"
    "github.com/lpmitchell/google-play-scraper/pkg/store"
)
...
import (
    ...
    "github.com/lpmitchell/google-play-scraper/pkg/collection"
    "github.com/lpmitchell/google-play-scraper/pkg/store"
)
...
import (
    ...
    "github.com/lpmitchell/google-play-scraper/pkg/developer"
)
...
import (
    ...
    "github.com/lpmitchell/google-play-scraper/pkg/reviews"
)
...
import (
    ...
    "github.com/lpmitchell/google-play-scraper/pkg/similar"
)
...
import (
    ...
    "github.com/lpmitchell/google-play-scraper/pkg/suggest"
)
